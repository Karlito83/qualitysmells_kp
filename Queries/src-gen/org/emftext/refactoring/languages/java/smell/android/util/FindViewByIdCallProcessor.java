...
/**
 * A match processor tailored for the org.emftext.refactoring.languages.java.smell.android.findViewByIdCall pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class FindViewByIdCallProcessor implements IMatchProcessor<FindViewByIdCallMatch> {
  /**
  ...
  @Override
  public void process(final FindViewByIdCallMatch match) {
    process(match.getA());
