...
/**
 * Pattern-specific match representation of the org.emftext.refactoring.languages.java.smell.android.findViewByIdCall pattern, 
 * to be used in conjunction with {@link FindViewByIdCallMatcher}.
 * 
...
public abstract class FindViewByIdCallMatch extends BasePatternMatch {
  private MethodCall fA;
  
  private static List<String> parameterNames = makeImmutableList("a");
  
  private FindViewByIdCallMatch(final MethodCall pA) {
    this.fA = pA;
  ...
  public List<String> parameterNames() {
    return FindViewByIdCallMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof FindViewByIdCallMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    FindViewByIdCallMatch other = (FindViewByIdCallMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return FindViewByIdCallMatcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends FindViewByIdCallMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends FindViewByIdCallMatch {
