...
/**
 * Pattern-specific match representation of the org.emftext.refactoring.languages.java.smell.android.slowForLoop pattern, 
 * to be used in conjunction with {@link SlowForLoopMatcher}.
 * 
...
public abstract class SlowForLoopMatch extends BasePatternMatch {
  private ForLoop fA;
  
  private static List<String> parameterNames = makeImmutableList("a");
  
  private SlowForLoopMatch(final ForLoop pA) {
    this.fA = pA;
  ...
  public List<String> parameterNames() {
    return SlowForLoopMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SlowForLoopMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    SlowForLoopMatch other = (SlowForLoopMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return SlowForLoopMatcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends SlowForLoopMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends SlowForLoopMatch {
